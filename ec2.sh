ssh -i ~/venv/automatedfishdetection/Study-is-happy.pem ubuntu@ec2-18-189-192-91.us-east-2.compute.amazonaws.com
...
scp -i ~/venv/automatedfishdetection/Study-is-happy.pem ~/datasets/fish_detection/update/instances.json ubuntu@ec2-18-189-192-91.us-east-2.compute.amazonaws.com:~/fish_detection/update/instances.json

# upload update.zip to ec2
scp -i ~/venv/automatedfishdetection/Study-is-happy.pem ~/datasets/fish_detection/update.zip ubuntu@ec2-18-189-192-91.us-east-2.compute.amazonaws.com:~/fish_detection/
...
scp -i ~/venv/automatedfishdetection/Study-is-happy.pem ubuntu@ec2-18-189-192-91.us-east-2.compute.amazonaws.com:~/fish_detection/predict.zip ~/datasets/fish_detection/
