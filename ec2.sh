ssh -i ~/Desktop/Study-is-happy.pem ubuntu@ec2-3-15-18-50.us-east-2.compute.amazonaws.com
...
scp -i ~/Desktop/Study-is-happy.pem ~/datasets/fish_detection/update/instances.json ubuntu@ec2-3-15-18-50.us-east-2.compute.amazonaws.com:~/fish_detection/update/instances.json

# upload update.zip to ec2
scp -i ~/Desktop/Study-is-happy.pem ~/datasets/fish_detection/update.zip ubuntu@ec2-3-15-18-50.us-east-2.compute.amazonaws.com:~/fish_detection/

# unzip update
unzip update.zip

# download model_final.pth to local
scp -i ~/Desktop/Study-is-happy.pem ubuntu@ec2-3-15-18-50.us-east-2.compute.amazonaws.com:~/fish_detection/outputs/model_final.pth ~/datasets/fish_detection/outputs/

# zip predict
zip -r predict.zip predict/

# download predict.zip to local
scp -i ~/Desktop/Study-is-happy.pem ubuntu@ec2-3-15-18-50.us-east-2.compute.amazonaws.com:~/fish_detection/predict.zip ~/datasets/fish_detection/

# nohup
nohup python predict.py >/dev/null 2>&1 &