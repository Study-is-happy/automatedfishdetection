...
dataset_dir = config.project_dir + 'init_train/'
...
def get_predict_annotation(annotation, width, height):
...
for image_id, instance in instances_dict.items():
    ...
    for annotation in enumerate(instance['annotations']):
        ...
        # if (annotation['category_id'] == 0 and annotation_size > 11000) or (annotation['category_id'] == 2 and (annotation_width > 710 and annotation_height > 800)):

        #     get_predict_annotation(annotation, width, height)
        ...
        # if (annotation['category_id'] == 0 and annotation_size > 7000) or (annotation['category_id'] == 2 and (annotation_width > 710 and annotation_height > 700)):
        ...
        # if (annotation['category_id'] == 0 and annotation_size < 7000) or (annotation['category_id'] == 2 and (annotation_width < 710 and annotation_height < 700)) or annotation['category_id'] == 3:
        ...
        if 'score' in annotation:
            ...
            #     annotation['score'], '0.2f'), color=color, size=15)
        else:
            linestyle = '-'
        ...
        if 'score' in annotation:
            plt.text(bbox[0] * width, bbox[1] * height - 3,
                     'predict', color='white', size=15, bbox={'facecolor': color, 'alpha': 0.5, 'pad': 3})
        else:
            plt.text(bbox[0] * width, bbox[1] * height - 3,
