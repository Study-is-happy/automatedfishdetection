...
for image_id, instance in instances_dict.items():
    ...
    for annotation in instance['annotations']:
        ...
        # if (annotation['category_id'] == 0 and (annotation_width < 100 or annotation_height < 50)) or (annotation['category_id'] == 2 and (annotation_width < 710 or annotation_height < 700) or annotation['category_id'] == 3):
        #     linestyle = 'dashed'
        #     color = 'grey'
