...
from My_detector import My_detector
...
for left_image_path, right_image_path in zip(sorted(glob.glob(left_dir + '*.tif')),
    ...
    # left_points, right_points = seagate_utils.get_good_match_points(sift, left_image, right_image, left_remap_mask, right_remap_mask)
